...
const COLOR_GROUPS = [
  ...
  },
  {
    ...
    title: "图表 / 文字",
    keys: [
      ["color", "chart_1", "单色阶梯 1"],
      ["color", "chart_2", "单色阶梯 2"],
      ["color", "chart_3", "单色阶梯 3"],
      ["color", "chart_4", "单色阶梯 4"],
      ...
      ["color", "chart_cat_6", "分类色板 6"],
      ["color", "chart_cat_7", "分类色板 7"],
      ["color", "chart_cat_8", "分类色板 8"],
