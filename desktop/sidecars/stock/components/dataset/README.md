...
popup / drilldown 则通过宿主侧 [`mei-lang/host-shell/app/assets/spa-navigation/`](../../../../host-shell/app/assets/spa-navigation/) 桥接到同一套 query contract；它不是 `dataset` 包中的第三个 renderer。
