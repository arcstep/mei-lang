...
pub fn host_auth_command(args: HostAuthArgs) -> Result<()> {
    let legacy_command = match args.command {
        ...
        HostAuthCommand::AddUser(args) => mei_host_auth::cli_args::LegacyAuthCommand::AddUser(
        ...
        HostAuthCommand::Describe(args) => mei_host_auth::cli_args::LegacyAuthCommand::Describe(
