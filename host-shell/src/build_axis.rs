//! Build route axis presets: `/apps/build/{app}/eval|region|content|eval/content`.
...
/// Parse `/apps/build/{app-id}/[eval|region|content|eval/content]` tail.
