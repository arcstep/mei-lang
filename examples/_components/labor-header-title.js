...
class MeiCockpitLaborHeaderTitle extends HTMLElement {
  constructor() {
    super();
    this._ro = null;
  }
...
if (!customElements.get("mei-cockpit-labor-header-title")) {
  customElements.define("mei-cockpit-labor-header-title", MeiCockpitLaborHeaderTitle);
}
