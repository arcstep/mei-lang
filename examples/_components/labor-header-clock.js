import { escapeHtml, formatNowParts, parseProps } from "./labor-shared.js";

class MeiCockpitLaborHeaderClock extends HTMLElement {
  connectedCallback() {
...
if (!customElements.get("mei-cockpit-labor-header-clock")) {
  customElements.define("mei-cockpit-labor-header-clock", MeiCockpitLaborHeaderClock);
}
