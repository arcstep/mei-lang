...
class MeiCockpitPersonCards extends HTMLElement {
  connectedCallback() {
...
if (!customElements.get("mei-cockpit-person-cards")) {
  customElements.define("mei-cockpit-person-cards", MeiCockpitPersonCards);
}
