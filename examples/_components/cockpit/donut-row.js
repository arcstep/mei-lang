...
class MeiCockpitDonutRow extends HTMLElement {
  connectedCallback() {
...
if (!customElements.get("mei-cockpit-donut-row")) {
  customElements.define("mei-cockpit-donut-row", MeiCockpitDonutRow);
}
