...
class MeiCockpitRankingList extends HTMLElement {
  connectedCallback() {
...
if (!customElements.get("mei-cockpit-ranking-list")) {
  customElements.define("mei-cockpit-ranking-list", MeiCockpitRankingList);
}
