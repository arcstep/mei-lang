...
class MeiCockpitCenterTop extends HTMLElement {
  connectedCallback() {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="wrap">
        <mei-cockpit-kpi-strip data-props="${kpiProps}"></mei-cockpit-kpi-strip>
        <div class="cards">
          <div class="stat-card">
            <h4>本年工人劳动合同签订人数</h4>
            <div class="stat-grid">
...
if (!customElements.get("mei-cockpit-center-top")) {
  customElements.define("mei-cockpit-center-top", MeiCockpitCenterTop);
}
