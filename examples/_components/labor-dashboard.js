...
class MeiCockpitLaborDashboard extends HTMLElement {
  connectedCallback() {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .digit {
          min-width: 34px; text-align: center; padding: 6px 4px; border-radius: 4px;
          font-size: 18px; font-weight: 800; color: #f0f9ff;
          background: rgba(15,23,42,.85);
          border: 1px solid rgba(56,189,248,.2);
        }
        .foot-metrics {
          display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; font-size: 11px; color: #94a3b8;
        }
      ...
      <div class="labor-root">
        <mei-cockpit-labor-header data-props="${hp}"></mei-cockpit-labor-header>
...
if (!customElements.get("mei-cockpit-labor-dashboard")) {
  customElements.define("mei-cockpit-labor-dashboard", MeiCockpitLaborDashboard);
}
