...
class MeiCockpitLaborSectionTitle extends HTMLElement {
  connectedCallback() {
...
if (!customElements.get("mei-cockpit-labor-section-title")) {
  customElements.define("mei-cockpit-labor-section-title", MeiCockpitLaborSectionTitle);
}
