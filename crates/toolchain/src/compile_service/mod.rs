...
pub use cache::{
    ...
    hydrate_compiled_app_from_disk_artifacts, is_compile_inflight, load_compile_artifact_only,
    load_compile_artifact_only_shared, probe_compiled_app_manifest_identity, peek_compile_cache,
