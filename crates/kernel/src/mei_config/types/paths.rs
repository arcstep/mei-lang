...
pub const WORKSPACE_RUNTIME_DIR_REL: &str = "deploy/runtime";
...
pub const WORKSPACE_PLATFORM_DIR_REL: &str = "deploy/runtime/platform";
pub const WORKSPACE_RUNTIME_LOGS_REL: &str = "deploy/runtime/logs";
pub const WORKSPACE_RUNTIME_CACHE_REL: &str = "deploy/runtime/cache";
...
pub const WORKSPACE_AGENT_LOCAL_DIR_REL: &str = "deploy/runtime/agent";
pub const WORKSPACE_AGENT_DB_REL: &str = "deploy/runtime/agent/agent.sqlite";
pub const LEGACY_WORKSPACE_AGENT_DB_REL: &str = ".mei/local/agent/agent.sqlite";
pub const WORKSPACE_SNAPSHOT_DIR_REL: &str = "deploy/runtime/agent/snapshot";
pub const WORKSPACE_SNAPSHOT_GIT_REL: &str = "deploy/runtime/agent/snapshot/git";
