...
pub(crate) const PROP_LAYOUT_COLUMNS_PREFER: &str = "layout_columns_prefer";
pub(crate) const PROP_LAYOUT_SPAN: &str = "layout_span";
pub(crate) const LAYOUT_POLICY_METRICS_AUTO: &str = "metrics_auto";
pub(crate) const LAYOUT_POLICY_METRICS_STRIP: &str = "metrics_strip";
pub(crate) const LAYOUT_POLICY_METRICS_2X2: &str = "metrics_2x2";
...
pub(crate) const DEFAULT_METRICS_AUTO_GAP: &str = "8px";
pub(crate) const DEFAULT_METRICS_AUTO_PADDING: &str = "12px";
pub(crate) const DEFAULT_METRICS_STRIP_GAP: &str = "8px";
pub(crate) const DEFAULT_METRICS_STRIP_PADDING: &str = "12px";
pub(crate) const DEFAULT_METRICS_2X2_GAP: &str = "8px";
pub(crate) const DEFAULT_METRICS_2X2_PADDING: &str = "12px";
