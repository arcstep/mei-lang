...
use crate::model::{
    Diagnostic, EntityDecl, FlowDecl, FrameDecl, PanelDecl, ResourceDecl, SceneDecl, Severity, WorldDecl,
};
use crate::typed_refs::{decode_ref_value, RefExpr, RefKind, SceneRegistry};

use super::super::super::load_external::{
...
pub(super) fn push_invalid_base_kind(
    diagnostics: &mut Vec<Diagnostic>,
    target_file: &str,
    kind_label: &str,
    expected: RefKind,
...
pub(super) fn resolve_world_ref(
    app_root: &Path,
    expr: &RefExpr,
    scene_registry: &SceneRegistry,
    diagnostics: &mut Vec<Diagnostic>,
...
pub(super) fn resolve_scene_ref(
    app_root: &Path,
    expr: &RefExpr,
    scene_registry: &SceneRegistry,
    diagnostics: &mut Vec<Diagnostic>,
...
pub(super) fn resource_ref_kind(expr: &RefExpr) -> Option<RefKind> {
    match expr.kind {
...
pub(super) fn resolve_resource_ref(
    app_root: &Path,
    expr: &RefExpr,
    scene_registry: &SceneRegistry,
    diagnostics: &mut Vec<Diagnostic>,
...
pub(super) fn resolve_entity_ref(
    app_root: &Path,
    expr: &RefExpr,
    scene_registry: &SceneRegistry,
    diagnostics: &mut Vec<Diagnostic>,
...
pub(super) fn resolve_component_ref(
    app_root: &Path,
    expr: &RefExpr,
    scene_registry: &SceneRegistry,
    diagnostics: &mut Vec<Diagnostic>,
