...
def metric_card_export(
    ...
    if export_id == "":
        fail("metric_card_export(...) requires `id`")
    return _declare({
        "kind": "panel_export",
        "id": export_id,
        "panel": metric_card(
            ...
            popup = popup,
            analysis = analysis,
            label_vertical_align = label_vertical_align,
            value_vertical_align = value_vertical_align,
            unit_vertical_align = unit_vertical_align,
            desc_vertical_align = desc_vertical_align,
        ),
    })
