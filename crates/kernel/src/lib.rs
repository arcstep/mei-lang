...
pub use compile::{
    ...
    ui_scope_for_block, UiScopeBlockAnnotation, UiScopePanelAnnotation,
...
pub use mei_config::{
    ...
    begin_prebuild_generation, begin_prebuild_generation_with_hint, attach_build_generation,
    clear_prebuild_build_root_override,
    finalize_and_promote_build, finish_prebuild_generation, prepare_dev_build_generation,
    prepare_dev_build_generation_with_hint,
    migrate_flat_build_to_store,
    generate_build_id, resolve_env_version, resolve_env_generation_id,
    resolve_env_generation_id_for_prebuild, resolve_workspace_version,
    ...
    BuildGenerationSpec, VersionDisplayIdentity, WorkspaceBuildGenerationConfig,
    normalize_env_generation_id, is_v2_app_root, is_app_mei_source_rel, is_dev_toolchain_alias,
    migrate_legacy_app_mei, migrate_apps_to_env_layout, migrate_build_var_store_to_env,
    migrate_legacy_workspace_mei, migrate_legacy_workspace_runtime_dir, apply_toolchain_store_symlinks, record_toolchain_install_links,
    clean_env_generations, toolchain_store_dir,
    app_build_store_dir, app_env_build_dir, app_env_dir, app_env_var_dir, app_var_store_dir,
    promote_build, read_build_manifest, read_links_state,
    resolve_app_build_store_root, resolve_active_build_id, resolve_dev_toolchain_version,
    resolve_toolchain_version, resolve_toolchain_version_with_hint, rollback_build, replace_env_generation,
    ...
    APP_ENV_REL, APP_BUILD_STORE_REL,
    ...
    DEV_TOOLCHAIN_ALIAS, DEV_TOOLCHAIN_VERSION, LEGACY_AUTH_JOURNAL_REL_PATH, LEGACY_WORKSPACE_AGENT_DB_REL,
...
pub use model::{
    ...
    ResourceDecl, DataMode, DataModeCeiling, ReviewProjection, ui_role_depth_rank,
