...
pub use compile::{
    access_parquet_import_required, app_declares_scene_from_root, block_instance_id,
    build_experience_index, build_experience_path, build_overview_backing,
    build_preview_panel_scope, build_preview_ui_scope, build_reachability_tree,
    build_runtime_analysis_contracts, build_runtime_analysis_graph, build_runtime_eval_plan,
    build_runtime_metric_artifacts, build_ui_layout_index, cached_load_xlsx_table_snapshot,
    capsule_path_from_namespaced_resource_id, catalog_preview_target_for_build_node,
    cell_normalize_rules_from_schema, clear_runtime_compile_caches, clear_runtime_eval_node_cache,
    coerce_calendar_columns_in_rows, coerce_row_to_schema, coerce_rows_to_schema, compile_app,
    compile_app_from_root, compile_app_from_root_with_options,
    ...
    EvalPlanNodeKind, EvalPlanScope, LayoutBudgetValidateOptions, ReachabilityTreeNode,
    ReachabilityTreeRoot, RequestDagMetrics, RuntimeMetricEvalReport, RuntimeMetricEvalScope,
    TableSnapshot, TableSnapshotKey, UiScopeBlockAnnotation, UiScopePanelAnnotation,
    DATA_SNAPSHOT_IMPORT_MANIFEST_SCHEMA_VERSION, DATA_SNAPSHOT_SCHEMA_VERSION,
    PORTABLE_SNAPSHOT_MARKER,
};
...
pub use mei_config::{
    admin_registry_artifact_path, admin_registry_artifact_path_for_app, app_build_store_dir,
    app_env_build_dir, app_env_dir, app_env_var_dir, app_mei_config_path,
    app_source_rel_path_lookup_keys, app_toml_path, app_var_store_dir, append_admin_audit,
    apply_asset_slot_current, apply_toolchain_store_symlinks, attach_build_generation,
    begin_prebuild_generation, begin_prebuild_generation_with_hint, canonical_app_source_rel_path,
    clean_env_generations, clear_prebuild_build_root_override, default_scene_assembly_key,
    delete_asset_slot_file, discover_admin_mdx_paths, discover_app_admin_resources,
    discover_provider_binding_catalog, discover_scene_root_catalog,
    filter_admin_resources_for_capabilities, finalize_and_promote_build,
    finish_prebuild_generation, generate_build_id, get_asset_slot, get_command_job,
    get_config_record, is_app_mei_source_rel, is_dev_toolchain_alias, is_plane_structure_mei_path,
    is_region_structure_mei_path, is_section_structure_mei_path, is_stock_catalog_app,
    is_stock_catalog_app_for_root, is_v2_app_root, list_asset_slots,
    list_workspace_scene_theme_catalog, load_admin_registry_artifact,
    merge_scene_theme_studio_patch,
    load_admin_registry_artifact_for_app, load_app_manifest, load_app_manifest_from_json_pair,
    load_app_manifest_from_toml, load_mei_config_for_app, load_workspace_auth_bundle,
    load_workspace_config, mei_config_compile_revision_digest, merge_ops_section,
    merge_theme_layout_draft_into_theme, merge_theme_layout_overlay, migrate_apps_to_env_layout,
    migrate_build_var_store_to_env, migrate_flat_build_to_store, migrate_json_pair_to_toml,
    migrate_legacy_app_mei, migrate_legacy_workspace_mei, migrate_legacy_workspace_runtime_dir,
    normalize_env_generation_id, normalize_stock_relative_path, ops_active_theme_revision_digest,
    ops_active_theme_revision_digest_app_only, ops_theme_layout_revision_digest,
    ops_themes_revision_digest, prepare_dev_build_generation,
    prepare_dev_build_generation_with_hint, promote_build, provider_bindings_for_scene,
    put_config_record, read_build_manifest, read_links_state, record_toolchain_install_links,
    replace_asset_slot, replace_env_generation, resolve_active_build_id,
    resolve_active_build_identity, resolve_active_build_identity_for_app,
    resolve_active_build_identity_with_hint, resolve_active_scene_theme_id,
    resolve_active_scene_theme_id_app_only, resolve_app_build_eval_cache_root,
    resolve_app_build_generation_from_current, resolve_app_build_root,
    resolve_app_build_store_root, resolve_app_data_snapshot_root, resolve_app_entry_main,
    resolve_app_eval_cache_root, resolve_app_id, resolve_app_main_path, resolve_app_mei_file_path,
    resolve_app_mei_store_root, resolve_app_registry_root, resolve_app_root, resolve_app_src_root,
    resolve_app_var_root, resolve_apps_root, resolve_assembled_scene_theme,
    resolve_asset_slot_download_path, resolve_authoring_root, resolve_build_footer_label,
    resolve_build_footer_label_with_hint, resolve_build_generation_for_prebuild,
    resolve_components_root, resolve_deploy_root, resolve_dev_toolchain_version,
    resolve_env_generation_id, resolve_env_generation_id_for_prebuild, resolve_env_version,
    resolve_live_ops_theme_value, resolve_mei_config_path, resolve_scene_assembly_rel,
    resolve_stock_root, resolve_templates_root, resolve_toolchain_root, resolve_toolchain_version,
    ...
    resolve_workspace_scene_theme_value, resolve_workspace_shell_theme,
    scene_theme_studio_editable_keys, scene_theme_studio_swatch_keys,
    resolve_workspace_source_root_from_app_root, resolve_workspace_version,
    restore_prebuild_build_root_override, rollback_build, run_import_job, set_mei_package_root,
    set_prebuild_build_root_override, slot_id_from_binding, snapshot_prebuild_build_root_override,
    ...
    theme_layout_overlay_keys, toolchain_store_dir, upload_asset_slot_file,
    validate_workspace_shell_theme, workspace_auth_config_path, workspace_auth_host_id,
    workspace_auth_state_dir, workspace_config_path, write_admin_registry_artifact,
    write_admin_registry_artifact_for_app, write_app_toml, write_build_manifest, write_links_state,
    write_mei_config, write_workspace_auth_bundle, write_workspace_config, AccessAiExternalConfig,
    AdminApplyPolicy, AdminArtifactRef, AdminArtifactRefs, AdminAuditEntry, AdminDangerLevel,
    AdminDiscoverOutcome, AdminDiscoveryDiagnostic, AdminEntryProjection, AdminJobRecord,
    AdminJobStatus, AdminNavigation, AdminRecordError, AdminRegistryArtifact, AdminRegistryEntry,
    AdminRegistryProjection, AppEntryConfig, AppFeaturesConfig, AppManifest, AppPathsConfig,
    AppTomlDocument, AssetSlotFileView, AssetSlotView, AuthKeyPairConfig, AuthUserConfig,
    BuildGenerationSpec, BuildLinks, BuildManifest, CleanEnvEntry, CleanEnvPolicy, CleanEnvReport,
    ClientBootstrapConfig, CompileScopeFilterConfig, ConfigRecordFile, DiscoverConfig,
    FileCacheConfig, FileCacheSettings, LinksState, MeiConfig, MemoryWarmupConfig,
    MigrateEnvReport, OpsBasemapEntry, OpsConfig, OpsConfigPatch, OpsSourceEntry,
    PrebuildGeneration, ProviderBinding, ProviderPayloadType, ProviderValidator, RuntimeConfig,
    ...
    SceneRootCatalogEntry, SmartWarmupConfig, StockCatalogKind, ToolchainLinks,
    VersionDisplayIdentity, WorkspaceAuthBundle, WorkspaceAuthConfig, WorkspaceBrandConfig,
    WorkspaceBuildConfig, WorkspaceBuildGenerationConfig, WorkspaceComplianceConfig,
    WorkspaceConfig, WorkspaceDeployDevEvalConfig, WorkspaceHostState, WorkspaceOpsConfig,
    ...
    WorkspaceWarmupDatasetConfig, WorkspaceWarmupXlsxConfig, ADMIN_AUDIT_REL_PATH,
    ADMIN_ENTRY_MODULE_FORBIDDEN, ADMIN_JOBS_REL_DIR, ADMIN_LEGACY_DATA_JSON_FORBIDDEN,
    ADMIN_LEGACY_DUAL_PROJECTION_FORBIDDEN, ADMIN_LEGACY_MANIFEST_FORBIDDEN,
    ADMIN_MODULE_ID_DUPLICATE, ADMIN_REGISTRY_ARTIFACT_FILENAME, ADMIN_REGISTRY_SCHEMA_VERSION,
    ADMIN_RESOURCE_API_VERSION, ADMIN_SCENE_ROOT_DUPLICATE, ADMIN_SCENE_ROOT_UNKNOWN,
    ADMIN_SOURCE_PATH_INVALID, ADMIN_UPLOAD_PREFIX, APP_BUILD_STORE_REL, APP_CONFIG_FILENAME,
    APP_ENV_REL, APP_TOML_FILENAME, APP_TOML_SCHEMA, APP_VAR_STORE_REL, AUTH_JOURNAL_REL_PATH,
    ...
    PRE_LOCAL_AUTH_JOURNAL_REL_PATH, PROVIDER_BINDING_DUPLICATE, PROVIDER_BINDING_INVALID,
    PROVIDER_BINDING_UNKNOWN, TOOLCHAIN_ACTIVE_REL, TOOLCHAIN_STORE_REL, WORKSPACE_AGENT_DB_REL,
    WORKSPACE_AGENT_LOCAL_DIR_REL, WORKSPACE_AUTH_DIR_REL, WORKSPACE_CONFIG_FILENAME,
...
pub use model::{
    accept_presentation_map, apply_app_narration_catalog, apply_cockpit_stage_decl,
    bind_programs_to_abi, compute_narration_digest, compute_structure_digest,
    diagnose_slot_missing, discover_narration_catalog, discover_narration_track_paths,
    is_stage_registry_candidate, presentation_map_is_absent, presentation_map_schema_ok,
    presentation_map_schema_version, profile_layout_policy_digest, project_abi,
    resolve_build_view_query, tab_visible_for_node, tabs_for_node_kind, ui_role_depth_rank,
    ui_role_within_max_depth, validate_abi_against_programs, AbiProjection, AbiProjectionInput,
    AnalysisEdge, AnalysisGraph, AnalysisNode, BlockDecl, BuildExecScope, BuildNodeId,
    BuildNodeKind, BuildViewTab, CockpitFillDecl, CockpitStageDecl, CockpitStepDecl, ColumnSchema,
    CompiledApp, CompiledSceneRoute, ComponentAsset, ContentCapability, ContentCapabilityId,
    ContentCapabilityKind, DataMode, DataModeCeiling, DataRef, DataTransform, DatasetSourceRef,
    DatasetView, DefaultObjectAssembly, Diagnostic, DimensionBinding, FillDownPolicy, FilterIntent,
    FilterIntentSource, FilterOperator, FlowDecl, FrameDecl, InteractionBinding, InteractionEvent,
    ...
    MetricShape, NarrationCatalog, NarrationCue, NarrationTargetCatalog, NarrationTiming,
    NarrationTrack, NarrationTrackRegistry, NarrationTrackRegistryEntry, ObjectCatalog,
    ...
    ObjectTypeContract, PageFill, PageProgram, PageVisibleBody, PanelRefEmbedDecl,
    ProfileLayoutPolicy, ProfileSpacingTokens, ProvenanceAnchor, QueryState, QueryTimeRange,
    ResolvedBuildViewQuery, ResourceDecl, Responder, ReviewProjection, RuleClickDecl,
    RuleEffectDecl, RuleOutcomeDecl, RuleRequireDecl, RuleStartDecl, RuleSubjectTimerDecl,
    RuleTimerDecl, RuntimeObjectIndex, RuntimeObjectIndexEntry, SceneContract, SceneDecl,
    SceneSlotModule, SceneSlotModuleId, ScrollOwnership, SemanticEdgeKind, SemanticNodeKind,
    SemanticSlotDecl, Severity, SizeAxisPolicy, SlotCardinality, SourceDecl, StageDescriptor,
    StageId, StageProfile, StageProgram, StageProgramIndex, StageProgramSummary, StageRegistry,
    StageRoute, StageSlideInput, StageSurface, StageUnit, StageUnitKind, SurfacePreviewPolicy,
    T2PageFileEntry, ThemeDecl, UiBudgetSummary, UiLayoutIndex, UiNodeDecl, UiScopeNode,
    UiScopeRole, UiSourceAnchor, UiTreeNode, WorkspaceAppMeta, WorkspaceNode, WorldCellDecl,
    WorldMetricLedgerEntry, WorldSemanticDataset, WorldSemanticExplainBlock,
    WorldSemanticFileIndex, WorldSemanticMetric, DEFAULT_OBJECT_ASSEMBLY_KIND,
    INTERACTION_PROTOCOL_SCHEMA_VERSION, NARRATION_DEFAULT_TRACK_AMBIGUOUS,
    NARRATION_TARGET_PRIVATE, NARRATION_TARGET_UNKNOWN, NARRATION_TRACK_ID_DUPLICATE,
