...
pub use mei_config::{
    ...
    begin_prebuild_generation_with_hint, canonical_app_source_rel_path, clean_env_generations,
    clear_prebuild_build_root_override, default_scene_assembly_key, discover_admin_mdx_paths,
    discover_app_admin_resources, discover_from_admin_ref, filter_admin_resources_for_capabilities,
    finalize_and_promote_build, finish_prebuild_generation, generate_build_id, get_asset_slot,
    get_command_job, get_config_path_record, get_config_record, is_app_mei_source_rel,
    is_dev_toolchain_alias, is_plane_structure_mei_path, is_region_structure_mei_path,
    is_section_structure_mei_path, is_stock_catalog_app, is_stock_catalog_app_for_root,
    is_v2_app_root, list_asset_slots, load_admin_manifest, load_admin_mdx_resource,
    load_app_manifest, load_app_manifest_from_json_pair, load_app_manifest_from_toml,
    load_mei_config_for_app, load_workspace_auth_bundle, load_workspace_config,
    lower_admin_mdx_document, mei_config_compile_revision_digest, merge_ops_section,
    ...
    normalize_env_generation_id, normalize_stock_relative_path, ops_theme_layout_revision_digest,
    ops_themes_revision_digest, parse_admin_manifest, parse_and_validate_admin_manifest,
    prepare_dev_build_generation, prepare_dev_build_generation_with_hint, promote_build,
    put_config_path_record, put_config_record, read_build_manifest, read_links_state,
    record_toolchain_install_links, render_admin_resource_mdx, replace_asset_slot,
    replace_env_generation, resolve_active_build_id, resolve_active_build_identity,
    resolve_active_build_identity_for_app, resolve_active_build_identity_with_hint,
    resolve_admin_manifest_path, resolve_app_build_generation_from_current, resolve_app_build_root,
    ...
    resolve_app_var_root, resolve_apps_root, resolve_authoring_root, resolve_build_footer_label,
    resolve_build_footer_label_with_hint, resolve_build_generation_for_prebuild,
    resolve_components_root, resolve_config_record_path, resolve_deploy_root,
    ...
    resolve_mei_config_path, resolve_scene_assembly_rel, resolve_slot_defs, resolve_stock_root,
    ...
    run_import_job, set_mei_package_root, set_prebuild_build_root_override,
    ...
    stock_templates_source, theme_layout_overlay_keys, toolchain_store_dir,
    validate_admin_manifest, validate_relative_sandbox_path, validate_workspace_shell_theme,
    workspace_auth_config_path, workspace_auth_host_id, workspace_auth_state_dir,
    workspace_config_path, write_app_toml, write_build_manifest, write_links_state,
    write_mei_config, write_workspace_auth_bundle, write_workspace_config, AccessAiExternalConfig,
    AdminAction, AdminApplyPolicy, AdminAuditEntry, AdminColumn, AdminDangerLevel,
    AdminDirtyPolicy, AdminDiscoverOutcome, AdminDiscoveryDiagnostic, AdminField,
    AdminFieldControl, AdminFieldOption, AdminIdempotency, AdminJobRecord, AdminJobStatus,
    AdminManifest, AdminManifestError, AdminMenuValue, AdminNavigation, AdminProviderKind,
    AdminRecordError, AdminRegistryProjection, AdminResourceProjection, AdminResourceSpec,
    AdminRevisionPolicy, AdminSection, AdminTemplate, AdminUiSurface, AdminUploadSpec, AppAdminRef,
    AppEntryConfig, AppFeaturesConfig, AppManifest, AppPathsConfig, AppTomlDocument, AssetSlotDef,
    AssetSlotSchemaDoc, AssetSlotView, AuthKeyPairConfig, AuthUserConfig, BuildGenerationSpec,
    ...
    WorkspaceAuthBundle, WorkspaceAuthConfig, WorkspaceBrandConfig, WorkspaceBuildConfig,
    ...
    WorkspaceWarmupXlsxConfig, ADMIN_AUDIT_REL_PATH, ADMIN_JOBS_REL_DIR,
    ADMIN_RESOURCE_API_VERSION, APP_BUILD_STORE_REL, APP_CONFIG_FILENAME, APP_ENV_REL,
    APP_TOML_FILENAME, APP_TOML_SCHEMA, APP_VAR_STORE_REL, AUTH_JOURNAL_REL_PATH,
...
pub use model::{
    accept_presentation_map, apply_cockpit_stage_decl, bind_programs_to_abi,
    compute_narration_digest, compute_structure_digest, diagnose_slot_missing,
    ...
    AdminPageProgram, AnalysisEdge, AnalysisGraph, AnalysisNode, BlockDecl, BuildExecScope,
    BuildNodeId, BuildNodeKind, BuildViewTab, CockpitFillDecl, CockpitStageDecl, CockpitStepDecl,
    ColumnSchema, CompiledApp, CompiledSceneRoute, ComponentAsset, ContentCapability,
    ContentCapabilityId, ContentCapabilityKind, DataMode, DataModeCeiling, DataRef, DataTransform,
    DatasetSourceRef, DatasetView, DefaultObjectAssembly, Diagnostic, DimensionBinding,
    FillDownPolicy, FilterIntent, FilterIntentSource, FilterOperator, FlowDecl, FrameDecl,
    InteractionBinding, InteractionEvent, InteractionIntent, InteractionSubject,
    LayoutBudgetManifest, LayoutBudgetManifestEntry, LayoutDecl, LegacyBuildQuery, LoadedResource,
    MetricContract, MetricPackContract, MetricRef, MetricShape, NarrationCatalog, NarrationCue,
    NarrationCueTarget, NarrationTrack, ObjectCatalog, ObjectCatalogAuthoringMode,
    ...
    ObjectTypeContract, PageProgram, PanelRefEmbedDecl, ProfileLayoutPolicy, ProfileSpacingTokens,
    ProvenanceAnchor, QueryState, QueryTimeRange, ResolvedBuildViewQuery, ResourceDecl, Responder,
    ReviewProjection, RuleClickDecl, RuleEffectDecl, RuleOutcomeDecl, RuleRequireDecl,
    RuleStartDecl, RuleSubjectTimerDecl, RuleTimerDecl, RuntimeObjectIndex,
    RuntimeObjectIndexEntry, SceneContract, SceneDecl, SceneSlotModule, SceneSlotModuleId,
    ScrollOwnership, SemanticEdgeKind, SemanticNodeKind, SemanticSlotDecl, Severity,
    SizeAxisPolicy, SlotCardinality, SourceDecl, StageDescriptor, StageId, StageProfile,
    StageProgram, StageProgramIndex, StageProgramSummary, StageRegistry, StageRoute,
    StageSlideInput, StageSurface, StageUnit, StageUnitKind, SurfacePreviewPolicy, T2PageFileEntry,
    ThemeDecl, UiBudgetSummary, UiLayoutIndex, UiNodeDecl, UiScopeNode, UiScopeRole,
    UiSourceAnchor, UiTreeNode, WorkspaceAppMeta, WorkspaceNode, WorldCellDecl,
