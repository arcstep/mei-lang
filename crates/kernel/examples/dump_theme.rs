fn main() {
    let app = std::path::PathBuf::from("/Users/xuehongwei/codeup/mei-projects/workspaces/ws-demo-v2/apps/zhifa");
    ...
    println!("gradient={g:?}");
    println!("shared={s:?}");
    println!("digest={}", mei_lang_kernel::ops_themes_revision_digest(&cfg));
}
