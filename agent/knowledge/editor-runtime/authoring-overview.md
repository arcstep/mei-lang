...
3. Treat `.mei/runtime/bin/mei-toolchain`, `.mei/runtime/bin/mei-lsp`, and `.mei/runtime/bin/mei-host-shell` as the canonical local binaries for the installed runtime layer.
