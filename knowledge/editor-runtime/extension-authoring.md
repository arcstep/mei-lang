...
- `docs/archive/mei-lang-v1/basic/06-extension-capability-provider-profile.md`
- component/template pack implementation docs under `docs/archive/mei-lang-v1/implementation/extensions/`
