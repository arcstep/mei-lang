...
fn page_shell_color_tokens() -> Value {
    serde_json::json!({
        ...
        "focus_ring_subtle": "rgba(96, 165, 250, 0.12)",
        ...
        "preview_excluded_stripe_a": "rgba(148, 163, 184, 0.055)",
        "preview_excluded_stripe_b": "rgba(15, 23, 42, 0.16)",
        ...
        "status_warn": "#fbbf24",
        "statusbar_accent_line": "rgba(45, 212, 191, 0.12)",
