...
async function loadManifest() {
  ...
  if (!Array.isArray(m.manageScripts) || !Array.isArray(m.accessScripts) || !Array.isArray(m.styles)) {
    throw new Error("bundle-manifest.json must contain manageScripts, accessScripts, styles arrays");
  }
  return m;
}
